...
object ExampleFlow {
    @InitiatingFlow
    @StartableByRPC
    class Initiator(val otherParty: Party ,val productName: String,val productColour: String,val status: String) : FlowLogic<SignedTransaction>() {
        /**
        ...
        override fun call(): SignedTransaction {
            ...
            val iouState = IOUState(serviceHub.myInfo.legalIdentities.first() , otherParty, UniqueIdentifier(), productName ,productColour,status)
            ...
            val updatedState = IOUState(serviceHub.myInfo.legalIdentities.first() , otherParty, UniqueIdentifier(), productName ,productColour,statusRecieved)
